        ...
        <div id="loginbox">            
            <form name="f" id="loginform" method="POST" class="form-vertical" action="main2.ftl">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly" style="width: 31px; height: 33px; "><i class="icon-lock"></i></span><input type="password" placeholder="Clave_Usuario" required id="password" name="j_password"/>
                        </div>
                    </div>
                </div>
